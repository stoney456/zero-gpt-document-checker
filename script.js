...
For each user, your output must include:
1. AI Plagiarism Percentage (e.g. 85%)
2. Analysis explaining how and why you gave that percentage
3. Specific excerpts from their text that indicate whether it is AI-generated or human-written, with a brief explanation for each excerpt
